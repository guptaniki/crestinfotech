...
{{--    <script src='{{asset('HTWF/scripts/s    cript.js')}}' type='text/javascript'></script>--}}
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Left Side Of Navbar -->
                <ul class="navbar-nav mr-auto" style="margin-left: auto !important;">
                ...
                <ul class="navbar-nav" >
                    ...
                    @guest
                        ...
                        @endif
                    @else
                        <li class="nav-item dropdown" style="margin-right: 1000%;">
                        ...
                        @foreach(session('cart') as $id => $details)
                            <div class="row cart-detail">
                                <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                    <img src="/images/product/{{ $details['photo'] }}" />
                                </div>
